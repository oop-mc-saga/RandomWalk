...
public class GuiMain extends javax.swing.JFrame {
    ...
    private RandomType randomType = RandomType.Uniform;
    /**
    ...
    private void setRandom(RandomType type){
        switch(type){
            case Uniform:
                drawPanel1.setRandom(new Uniform(-1.,1.));
                break;
            default:
                drawPanel1.setRandom(new Uniform(-1.,1.));
                break;
...
//    @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        drawPanel1 = new gui.continuous.DrawPanel();
    ...
    private gui.continuous.DrawPanel drawPanel1;
